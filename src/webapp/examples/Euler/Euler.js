...
'events' : [
        ...
        {'start': '1723-01-01',
            'title': 'Entered University of Basel',
            'durationEvent' : false
        },

        {'start': '1727-05-17',
            'end': '1741-06-19',
            'title': 'Leonhard Euler in St. Petersburg (1727 - 1741)',
            'durationEvent' : true
        },

        {'start': '1741-06-19',
            'end': '1760-01-01',
            'title': 'Leonhard Euler in Berlin (1741 - 1760????) ',
            'durationEvent' : true
        },

         {'start': '1760-01-01',
             'end': '1783-09-18',
             'title': 'Leonhard Euler in St. Petersburg (1760???? - 1783????) ',
             'durationEvent' : true
         },

        {'start': '1783-09-18',
            'title': 'Died',
            'description': 'Euler died on September 18, 1783 in St. Petersburg, Russia. ',
            'image': '220px-Euler_GDR_stamp.jpg',
            'durationEvent' : false
        },
